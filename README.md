...
Инструмент визуализации шрафа зависимостей для менеджера пакетов. Программа позволяет анализировать и отображать зависимости между пакетами без использования сторонних менеджеров пакетов, работая напрямую с репозиториями Ubuntu.
