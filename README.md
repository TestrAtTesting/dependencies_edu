...
Инструмент визуализации шрафа зависимостей для менеджера пакетов. Программа позволяет анализировать и отображать зависимости между пакетами без использования сторонних менеджеров пакетов, работая напрямую с репозиториями Ubuntu. Вариант 17. Группа - ИКБО-21-24.
...
1. Скачайте файлы репозитория и распакуйте прямо в папке загрузок.
...
## 4. Примеры использования:
   ...
   Тестирование: вводим:
   ```powershell
   C:\Downloads\dependencies_edu-main\configTest.toml
   ```
